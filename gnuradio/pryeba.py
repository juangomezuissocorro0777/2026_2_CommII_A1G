...
import pryeba_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading



class pryeba(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "pryeba")
...
def main(top_block_cls=pryeba, options=None):
